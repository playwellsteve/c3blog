...
namespace modules\pwauthmodule\fields;

use modules\pwauthmodule\PWAuthModule;
use modules\pwauthmodule\assetbundles\pwauthmodulefieldfield\PWAuthModuleFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class PWAuthModuleField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('pwauth-module', 'PWAuthModuleField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'pwauth-module/_components/fields/PWAuthModuleField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(PWAuthModuleFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').PWAuthModulePWAuthModuleField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'pwauth-module/_components/fields/PWAuthModuleField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
